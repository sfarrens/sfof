# /home/sartor/pymodule/euclid/dm/Interfaces/pro/le3/galcluster_stub.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:376dbacfc275f1428511fe9136edf32a7ac714da
# Generated 2014-07-23 16:11:22.133163 by PyXB version 1.2.3
# Namespace http://euclid.esa.org/schema/Interfaces/pro/le3/galcluster
...
Namespace = pyxb.namespace.NamespaceForURI(u'http://euclid.esa.org/schema/Interfaces/pro/le3/galcluster', create_if_missing=True)
...
class CTD_ANON (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {http://euclid.esa.org/schema/Interfaces/pro/le3/galcluster}Catalog uses Python identifier Catalog
    __Catalog = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'Catalog'), 'Catalog', '__httpeuclid_esa_orgschemaInterfacesprole3galcluster_CTD_ANON_httpeuclid_esa_orgschemaInterfacesprole3galclusterCatalog', False, pyxb.utils.utility.Location('/home/sartor/workspace/EUCLID/svn_tot/schema/branches/challenge4/Interfaces/pro/le3/cog/euc-test-le3-cog-in.xsd', 11, 16), )

    
    Catalog = property(__Catalog.value, __Catalog.set, None, None)

    
    # Element {http://euclid.esa.org/schema/Interfaces/pro/le3/galcluster}Params uses Python identifier Params
    __Params = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'Params'), 'Params', '__httpeuclid_esa_orgschemaInterfacesprole3galcluster_CTD_ANON_httpeuclid_esa_orgschemaInterfacesprole3galclusterParams', False, pyxb.utils.utility.Location('/home/sartor/workspace/EUCLID/svn_tot/schema/branches/challenge4/Interfaces/pro/le3/cog/euc-test-le3-cog-in.xsd', 12, 16), )
...
class CTD_ANON_ (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {http://euclid.esa.org/schema/Interfaces/pro/le3/galcluster}Clusters uses Python identifier Clusters
    __Clusters = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'Clusters'), 'Clusters', '__httpeuclid_esa_orgschemaInterfacesprole3galcluster_CTD_ANON__httpeuclid_esa_orgschemaInterfacesprole3galclusterClusters', False, pyxb.utils.utility.Location('/home/sartor/workspace/EUCLID/svn_tot/schema/branches/challenge4/Interfaces/pro/le3/cog/euc-test-le3-cog-out.xsd', 11, 16), )

    
    Clusters = property(__Clusters.value, __Clusters.set, None, None)

    
    # Element {http://euclid.esa.org/schema/Interfaces/pro/le3/galcluster}members uses Python identifier members
    __members = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'members'), 'members', '__httpeuclid_esa_orgschemaInterfacesprole3galcluster_CTD_ANON__httpeuclid_esa_orgschemaInterfacesprole3galclustermembers', False, pyxb.utils.utility.Location('/home/sartor/workspace/EUCLID/svn_tot/schema/branches/challenge4/Interfaces/pro/le3/cog/euc-test-le3-cog-out.xsd', 12, 16), )
